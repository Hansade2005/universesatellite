...
const translations = {
  fr: {
    ...
    about_p1: "est une entreprise de services numériques basée à Yaoundé. Depuis 2022, nous accompagnons les entreprises, institutions et particuliers dans leur transformation digitale avec des solutions innovantes, fiables et adaptées au contexte africain.",
    ...
    test: [
      { name: 'Jean-Pierre Nkoulou', role: 'Directeur Général', company: 'Groupe Nkoulou & Fils', text: "UniverS Satellite a transformé notre gestion interne avec un système sur mesure. Leur équipe est réactive, professionnelle et toujours à l'écoute. Un vrai partenaire technologique." },
      ...
      { name: 'Alphonse Tchounga', role: 'DSI', company: 'Cameroon Agri-Business', text: "Le déploiement réseau réalisé par UniverS Satellite est impeccable. Nos 5 sites sont maintenant interconnectés avec une fiabilité de 99.9%. Service exceptionnel." },
    ],
  ...
  en: {
    ...
    about_p1: 'is a digital services company based in Yaoundé. Since 2022, we have been supporting businesses, institutions and individuals in their digital transformation with innovative, reliable and Africa-adapted solutions.',
    ...
    test: [
      { name: 'Jean-Pierre Nkoulou', role: 'CEO', company: 'Groupe Nkoulou & Fils', text: 'UniverS Satellite transformed our internal management with a custom-built system. Their team is responsive, professional and always attentive. A true technology partner.' },
      ...
      { name: 'Alphonse Tchounga', role: 'CTO', company: 'Cameroon Agri-Business', text: 'The network deployment by UniverS Satellite is flawless. Our 5 sites are now interconnected with 99.9% reliability. Exceptional service.' },
    ],
