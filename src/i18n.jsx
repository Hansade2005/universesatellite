...
const translations = {
  fr: {
    ...
    // Hero
    hero_badge: 'Basé à Yaoundé, Cameroun • Depuis 2022',
    ...
    about_p1: "est une entreprise de services numériques basée à Yaoundé. Fondée en 2020, puis officiellement enregistrée en 2022, nous accompagnons les entreprises, institutions et particuliers dans leur transformation digitale avec des solutions innovantes, fiables et adaptées au contexte africain.",
    ...
    test: [
      { name: 'Jean-Pierre Nkoulou', role: 'Directeur Général', company: 'Groupe Nkoulou & Fils', text: "1. Univers Satellites a transformé notre gestion interne avec un système sur mesure. Leur équipe est réactive, professionnelle et toujours à l'écoute. Un vrai partenaire technologique." },
      ...
      { name: 'Alphonse Tchounga', role: 'DSI', company: 'Cameroon Agri-Business', text: "2. Le déploiement réseau réalisé par Univers Satellites est impeccable. Nos 5 sites sont maintenant interconnectés avec une fiabilité de 99.9%. Outils utilisés : Power BI, SQL, Python, Server Management Studio, Tableau. Service exceptionnel." },
    ],
    ...
    ct_wa_source: '*UniverS Satellite - Site Web*',
    ct_wa_name: '*Nom :*',
    ct_wa_email: '*Email :*',
    ct_wa_phone: '*Tel :*',
    ct_wa_msg: '*Message :*',
    ...
    ft_svc_list: ['Développement Web & Mobile', 'Automatisation & SI', 'Architectures Réseaux', 'Gadgets Publicitaires', 'Assistance & Conseil', 'Formation'],
    ft_contact: 'Contact',
  ...
  en: {
    ...
    hero_badge: 'Based in Yaoundé, Cameroon • Since 2022',
    ...
    about_p1: 'is a digital services company based in Yaoundé. Founded in 2020 and officially registered in 2022, we have been supporting businesses, institutions and individuals in their digital transformation with innovative, reliable and Africa-adapted solutions.',
    ...
    test: [
      { name: 'Jean-Pierre Nkoulou', role: 'CEO', company: 'Groupe Nkoulou & Fils', text: '1. UniverS Satellite transformed our internal management with a custom-built system. Their team is responsive, professional and always attentive. A true technology partner.' },
      ...
      { name: 'Alphonse Tchounga', role: 'CTO', company: 'Cameroon Agri-Business', text: '2. The network deployment by UniverS Satellite is flawless. Our 5 sites are now interconnected with 99.9% reliability. Tools used: Power BI, SQL, Python, Server Management Studio, Tableau. Exceptional service.' },
    ],
    ...
    ct_wa_source: '*UniverS Satellite - Website*',
    ct_wa_name: '*Name:*',
    ct_wa_email: '*Email:*',
    ct_wa_phone: '*Phone:*',
    ct_wa_msg: '*Message:*',
    ...
    ft_nav: 'Navigation',
    ft_services: 'Services',
    ft_svc_list: ['Web & Mobile Development', 'IS Automation', 'Network Architecture', 'Advertising & Branding', 'Support & Consulting', 'Training'],
    ft_contact: 'Contact',
