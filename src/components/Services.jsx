...
import { HiCode, HiCog, HiGlobe, HiColorSwatch, HiSupport, HiAcademicCap, HiLockClosed, HiDesktopComputer } from 'react-icons/hi';

const icons = [HiCode, HiCog, HiGlobe, HiColorSwatch, HiSupport, HiAcademicCap, HiLockClosed, HiDesktopComputer];
