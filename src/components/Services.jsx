...
import { HiCode, HiCog, HiGlobe, HiColorSwatch, HiSupport, HiAcademicCap, HiChartBar, HiLockClosed, HiDesktopComputer } from 'react-icons/hi';

const icons = [HiCode, HiCog, HiGlobe, HiColorSwatch, HiSupport, HiAcademicCap, HiChartBar, HiLockClosed, HiDesktopComputer];
